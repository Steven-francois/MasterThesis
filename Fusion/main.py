...
if __name__ == "__main__":
    data_folder = "Fusion/DATA_20250417_153534/20250417_154040/"
    ...
    rdc_reader = Rpr(f"{data_folder}radar_eth_20250417_154040.pcapng", rdc_file)
    can_file = f"{data_folder}radar_can_20250417_154040.pcapng"
    can_output_file = f"{result_folder}radar_can_data.npy"
    canReader = RadarCanReader()
    lidar_file = f"{data_folder}lidar_20250417_154040.pcapng"
    ...
    # Load radar data
    rdc_reader.load()
    canReader.load(f"{result_folder}radar_can_data.npy")
    ...
    combine_lidar_speed(lidar_npy_file, new_image_folder, combined_lidar_npy_file)